...
const loadFileRoutes = function (app) {
  ...
  app.route('/orders/:orderId')
    .put(
      ...
      hasRole('customer'),
      checkEntityExists(Order, 'orderId'),
      OrderMiddleware.checkOrderCustomer, // para editar un pedido, tienes que ser su dueño
      OrderMiddleware.checkOrderIsPending,
    ...
    .delete(
      ...
      OrderMiddleware.checkOrderIsPending, // el pedido tiene que estar pendiente y pertenecer al cliente en cuestión
